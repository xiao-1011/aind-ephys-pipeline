#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# PFC v3 — batch3: KS4 + TDC2 only on unprocessed Joana sessions
# (excludes 986170 [done in batch2] and 999770)
# ─────────────────────────────────────────────────────────────────────────────
...
export DATA_PATH="/cfs/klemming/projects/supr/dmclab/Joana/ephys_batch3"
...
OUTPUT_BASE="/cfs/klemming/projects/supr/dmclab/ephys-pipeline-output/pfcv3-batch3"
