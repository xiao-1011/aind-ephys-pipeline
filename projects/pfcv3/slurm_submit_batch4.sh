#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# PFC v3 — batch4: KS4 + TDC2 only on unprocessed Joana sessions
# (animals 1020227, 1021219, 1031912, 1033993; 16 sessions)
# ─────────────────────────────────────────────────────────────────────────────
...
export DATA_PATH="/cfs/klemming/projects/supr/dmclab/Joana/ephys_batch4"
...
OUTPUT_BASE="/cfs/klemming/projects/supr/dmclab/ephys-pipeline-output/pfcv3-batch4"
