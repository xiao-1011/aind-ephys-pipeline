#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# PFC v3 — batch8 (FINAL): KS4 + TDC2 on 5 animals + 986168 3 partial sessions
# 18 sessions total
# ─────────────────────────────────────────────────────────────────────────────
...
export DATA_PATH="/cfs/klemming/projects/supr/dmclab/Joana/ephys_batch8"
...
OUTPUT_BASE="/cfs/klemming/projects/supr/dmclab/ephys-pipeline-output/pfcv3-batch8"
...
ml PDC/26.03
ml miniconda3/26.3.2-2-cpeGNU-26.03
ml apptainer/1.5.1-cpeGNU-26.03
