#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# PFC v3 — batch7: KS4 + TDC2 on 6 animals (1053835, 1060148, 1060358, 1061220, 1061233, 1061234)
# 24 sessions total
# ─────────────────────────────────────────────────────────────────────────────
...
export DATA_PATH="/cfs/klemming/projects/supr/dmclab/Joana/ephys_batch7"
...
OUTPUT_BASE="/cfs/klemming/projects/supr/dmclab/ephys-pipeline-output/pfcv3-batch7"
