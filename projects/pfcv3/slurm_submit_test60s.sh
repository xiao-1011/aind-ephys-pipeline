#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# PFC v3 — test60s: KS4 + TDC2 only on unprocessed Joana sessions
# (animals 986169, 999770; 6 sessions — KS4+TDC2)
# ─────────────────────────────────────────────────────────────────────────────
...
export DATA_PATH="/cfs/klemming/projects/supr/dmclab/Joana/ephys_test60s"
...
OUTPUT_BASE="/cfs/klemming/projects/supr/dmclab/ephys-pipeline-output/pfcv3-test60s"
